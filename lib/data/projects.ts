...
export const projects: Project[] = [
  {
    ...
    screenshots: [
      ...
      "/screenshots/stoke/3-stoke-select-grill.webp",
      "/screenshots/stoke/4-stoke-select-wood.webp",
      "/screenshots/stoke/5-stoke-active-cook.webp",
      "/screenshots/stoke/6-stoke-reference.webp",
      "/screenshots/stoke/7-stoke-brisket.webp",
